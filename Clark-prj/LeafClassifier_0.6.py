...
bestScore=float('-inf')
score=0
for neurons in range(120, 130,1):
  for eta in range(1,10,1):
    ...
    for train, validation in kf.split(X):
      ...
      mlp =  MLPRegressor(hidden_layer_sizes=(neurons, neurons//2, neurons//4, neurons//8), tol=tolerance, verbose=False, learning_rate_init=eta)
...
if True:
    ...
    mlp =  MLPRegressor(hidden_layer_sizes=(bestNeurons, bestNeurons//2, bestNeurons//4, bestNeurons//8), tol=tolerance, verbose=True, learning_rate_init=bestEta)
